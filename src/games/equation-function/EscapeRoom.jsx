...
const animationStyles = `
  ...
  /* Ultra small screen optimizations for 258x879 */
...
const styles = {
  container: { 
    ...
    '@media (min-width: 769px)': { maxWidth: '1000px', margin: '20px auto', padding: '16px', borderRadius: '20px' } 
  },
  enemyDefeatOverlay: { position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1000, pointerEvents: 'none', width: '85%', maxWidth: '240px' },
  enemyDefeatBubble: { backgroundColor: '#ffd93d', padding: '4px 8px', borderRadius: '12px', display: 'flex', alignItems: 'center', gap: '4px', boxShadow: '0 2px 8px rgba(0,0,0,0.3)', flexWrap: 'wrap', justifyContent: 'center', '@media (min-width: 769px)': { padding: '15px 25px', gap: '15px' } },
  enemyDefeatEmoji: { fontSize: '16px', '@media (min-width: 769px)': { fontSize: '36px' } },
  enemyDefeatText: { fontSize: '8px', fontWeight: 'bold', color: '#333', '@media (min-width: 769px)': { fontSize: '18px' } },
  enemyDefeatXp: { fontSize: '7px', color: '#4caf50', fontWeight: 'bold', backgroundColor: 'white', padding: '1px 4px', borderRadius: '8px', '@media (min-width: 769px)': { fontSize: '16px', padding: '4px 10px' } },
  visualRoom: { position: 'relative', backgroundColor: '#2d1b0e', borderRadius: '6px', padding: '4px', marginBottom: '6px', minHeight: '120px', boxShadow: 'inset 0 0 15px rgba(0,0,0,0.5), 0 2px 4px rgba(0,0,0,0.3)', border: '1.5px solid #5c3a1e', overflow: 'hidden', '@media (min-width: 769px)': { padding: '20px', minHeight: '320px', borderRadius: '16px', borderWidth: '4px' } },
  roomWalls: { position: 'relative', height: '110px', '@media (min-width: 769px)': { height: '280px' } },
  roomWallLeft: { position: 'absolute', left: 0, top: 0, width: '4px', height: '100%', backgroundColor: '#8B6914', background: 'linear-gradient(180deg, #a07828 0%, #6b4c1a 100%)', borderRadius: '1px 0 0 1px', '@media (min-width: 769px)': { width: '20px' } },
  roomWallRight: { position: 'absolute', right: 0, top: 0, width: '4px', height: '100%', backgroundColor: '#8B6914', background: 'linear-gradient(180deg, #a07828 0%, #6b4c1a 100%)', borderRadius: '0 1px 1px 0', '@media (min-width: 769px)': { width: '20px' } },
  roomWallTop: { position: 'absolute', top: 0, left: 0, width: '100%', height: '4px', backgroundColor: '#8B6914', background: 'linear-gradient(90deg, #a07828 0%, #6b4c1a 100%)', borderRadius: '1px 1px 0 0', '@media (min-width: 769px)': { height: '20px' } },
  roomFloor: { position: 'absolute', bottom: 0, left: 0, width: '100%', height: '12px', backgroundColor: '#4a2a0a', background: 'repeating-linear-gradient(45deg, #5c3612, #5c3612 8px, #6b4015 8px, #6b4015 16px)', borderRadius: '0 0 4px 4px', '@media (min-width: 769px)': { height: '40px' } },
  escapeDoor: { position: 'absolute', bottom: '12px', width: '28px', height: '50px', transition: 'all 0.5s ease', cursor: 'pointer', zIndex: 10, '@media (min-width: 769px)': { bottom: '40px', width: '80px', height: '140px' } },
  escapeDoorOpen: { transform: 'translateX(2px)', opacity: 0.9 },
  doorFrame: { width: '100%', height: '100%', backgroundColor: '#3d2b1a', border: '1px solid #8B6914', borderRadius: '2px', boxShadow: 'inset 0 0 2px rgba(0,0,0,0.5)', position: 'relative', '@media (min-width: 769px)': { borderWidth: '3px' } },
  ...
  lockedDoorContent: { color: '#ff6b6b', fontSize: '4px', fontWeight: 'bold', textAlign: 'center', '@media (min-width: 769px)': { fontSize: '10px' } },
  lockedDoorText: { display: 'block', fontSize: '5px', '@media (min-width: 769px)': { fontSize: '14px' } },
  lockedDoorSubtext: { display: 'block', fontSize: '3px', marginTop: '1px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '8px', marginTop: '5px' } },
  openDoorContent: { color: '#4caf50', fontSize: '5px', fontWeight: 'bold', transform: 'rotate(-90deg)', whiteSpace: 'nowrap', '@media (min-width: 769px)': { fontSize: '14px' } },
  openDoorText: { display: 'inline-block' },
  doorKnob: { position: 'absolute', right: '1px', top: '50%', transform: 'translateY(-50%)', width: '2px', height: '2px', backgroundColor: '#ffd700', borderRadius: '50%', '@media (min-width: 769px)': { width: '10px', height: '10px', right: '5px' } },
  distanceIndicator: { position: 'absolute', bottom: '2px', left: '50%', transform: 'translateX(-50%)', backgroundColor: 'rgba(0,0,0,0.7)', padding: '1px 4px', borderRadius: '6px', fontSize: '5px', color: 'white', textAlign: 'center', zIndex: 15, whiteSpace: 'nowrap', '@media (min-width: 769px)': { bottom: '10px', padding: '8px 15px', fontSize: '12px' } },
  distanceBar: { width: '50px', height: '2px', backgroundColor: '#333', borderRadius: '1px', marginTop: '1px', overflow: 'hidden', '@media (min-width: 769px)': { width: '150px', height: '6px', marginTop: '5px' } },
  distanceFill: { height: '100%', backgroundColor: '#4caf50', transition: 'width 0.3s ease' },
  enemySprite: { position: 'absolute', left: '50%', top: '30%', transform: 'translate(-50%, -50%)', textAlign: 'center', zIndex: 5, '@media (min-width: 769px)': { top: '50%' } },
  enemyAvatar: { backgroundColor: '#2a1a0a', borderRadius: '50%', width: '32px', height: '32px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px solid #ff4444', boxShadow: '0 0 4px rgba(255,0,0,0.5)', '@media (min-width: 769px)': { width: '80px', height: '80px', borderWidth: '3px' } },
  enemyEmoji: { fontSize: '18px', '@media (min-width: 769px)': { fontSize: '42px' } },
  enemyNameTag: { fontSize: '5px', backgroundColor: '#ff4444', padding: '1px 2px', borderRadius: '4px', marginTop: '1px', color: 'white', fontWeight: 'bold', '@media (min-width: 769px)': { fontSize: '10px', padding: '2px 8px', marginTop: '4px' } },
  playerSprite: { position: 'absolute', bottom: '15px', textAlign: 'center', zIndex: 5, transition: 'left 0.3s ease', '@media (min-width: 769px)': { bottom: '60px' } },
  playerAvatar: { backgroundColor: '#1a3a5c', borderRadius: '50%', width: '28px', height: '28px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '1px solid #4caf50', boxShadow: '0 0 4px rgba(76,175,80,0.5)', '@media (min-width: 769px)': { width: '60px', height: '60px', borderWidth: '3px' } },
  playerEmoji: { fontSize: '15px', '@media (min-width: 769px)': { fontSize: '32px' } },
  playerNameTag: { fontSize: '4px', backgroundColor: '#4caf50', padding: '1px 2px', borderRadius: '4px', marginTop: '1px', color: 'white', fontWeight: 'bold', '@media (min-width: 769px)': { fontSize: '8px', padding: '1px 6px', marginTop: '2px' } },
  bloodEffect: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '20px', opacity: 0.8, animation: 'fadeOut 0.5s ease-out', pointerEvents: 'none', zIndex: 20, '@media (min-width: 769px)': { fontSize: '60px' } },
  puzzleArea: { marginTop: '6px', '@media (min-width: 769px)': { marginTop: '20px' } },
  header: { marginBottom: '6px' },
  scoreTimeContainer: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '3px', fontSize: '7px', fontWeight: 'bold', flexWrap: 'wrap', gap: '3px', '@media (min-width: 769px)': { fontSize: '18px', marginBottom: '10px', gap: '10px' } },
  score: { color: '#ffd93d', background: 'rgba(0,0,0,0.3)', padding: '1px 4px', borderRadius: '8px', '@media (min-width: 769px)': { padding: '5px 12px', borderRadius: '20px' } },
  timer: { color: '#ff6b6b', background: 'rgba(0,0,0,0.3)', padding: '1px 4px', borderRadius: '8px', '@media (min-width: 769px)': { padding: '5px 12px' } },
  livesContainer: { color: '#ff4444', background: 'rgba(0,0,0,0.3)', padding: '1px 4px', borderRadius: '8px', display: 'flex', alignItems: 'center', gap: '1px', fontSize: '6px', '@media (min-width: 769px)': { padding: '5px 12px', gap: '5px', fontSize: '16px' } },
  xpDisplay: { display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '3px', marginBottom: '3px', padding: '2px', backgroundColor: 'rgba(255,215,0,0.2)', borderRadius: '8px', fontSize: '6px', fontWeight: 'bold', color: '#ffd93d', flexWrap: 'wrap', '@media (min-width: 769px)': { gap: '10px', marginBottom: '10px', padding: '8px', fontSize: '14px' } },
  xpBreakdown: { fontSize: '5px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '11px' } },
  progressBar: { width: '100%', height: '3px', backgroundColor: '#1e1e2e', borderRadius: '2px', overflow: 'hidden', marginBottom: '2px', '@media (min-width: 769px)': { height: '8px', marginBottom: '8px' } },
  progressFill: { height: '100%', backgroundColor: '#4caf50', transition: 'width 0.3s ease' },
  progressText: { textAlign: 'center', fontSize: '6px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '13px' } },
  equationCard: { backgroundColor: '#1e1e2e', borderRadius: '6px', padding: '6px', textAlign: 'center', '@media (min-width: 769px)': { padding: '30px', borderRadius: '16px' } },
  difficultyBadge: { display: 'inline-block', padding: '1px 5px', borderRadius: '8px', fontSize: '6px', fontWeight: 'bold', marginBottom: '6px', color: '#fff', textTransform: 'uppercase', '@media (min-width: 769px)': { padding: '4px 12px', fontSize: '11px', marginBottom: '25px' } },
  mcContainer: { marginBottom: '6px' },
  mcQuestionText: { fontSize: '9px', color: '#fff', marginBottom: '8px', lineHeight: '1.3', whiteSpace: 'pre-line', textAlign: 'center', '@media (min-width: 769px)': { fontSize: '20px', marginBottom: '25px' } },
  optionsContainer: { display: 'flex', flexDirection: 'column', gap: '4px', marginBottom: '8px', '@media (min-width: 769px)': { gap: '12px', marginBottom: '20px' } },
  optionButton: { display: 'flex', alignItems: 'center', gap: '4px', padding: '4px 6px', backgroundColor: '#2a2a4a', border: '1px solid #4a4a6a', borderRadius: '5px', cursor: 'pointer', transition: 'all 0.2s', textAlign: 'left', fontSize: '7px', color: '#fff', '@media (min-width: 769px)': { gap: '15px', padding: '15px 20px', fontSize: '16px', borderRadius: '10px' } },
  optionLetter: { fontWeight: 'bold', fontSize: '8px', minWidth: '14px', color: '#ffd93d', '@media (min-width: 769px)': { fontSize: '18px', minWidth: '30px' } },
  optionText: { flex: 1, fontSize: '6px', '@media (min-width: 769px)': { fontSize: '14px' } },
  answerContainer: { marginBottom: '6px', padding: '4px', backgroundColor: '#0f0f1f', borderRadius: '6px', border: '1px solid #ff9800', '@media (min-width: 769px)': { marginBottom: '25px', padding: '25px', borderRadius: '16px' } },
  answerSubmitButton: { width: '100%', padding: '5px 8px', fontSize: '8px', backgroundColor: '#ff4444', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer', transition: 'all 0.3s', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.5px', minHeight: '28px', '@media (min-width: 769px)': { padding: '18px 24px', fontSize: '18px', letterSpacing: '2px', minHeight: '60px' } },
  feedback: { padding: '4px', marginBottom: '4px', backgroundColor: '#2a2a4a', borderRadius: '5px', fontSize: '6px', lineHeight: '1.3', color: '#fff', '@media (min-width: 769px)': { padding: '12px', fontSize: '14px' } },
  feedbackDeath: { padding: '4px', marginBottom: '4px', backgroundColor: '#8b0000', borderRadius: '5px', fontSize: '6px', lineHeight: '1.3', color: '#fff', fontWeight: 'bold', '@media (min-width: 769px)': { padding: '12px', fontSize: '14px' } },
  hint: { padding: '4px', marginBottom: '4px', backgroundColor: '#ff9800', borderRadius: '5px', fontSize: '6px', color: '#fff', '@media (min-width: 769px)': { padding: '12px', fontSize: '14px' } },
  stats: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '4px', paddingTop: '4px', borderTop: '1px solid #3a3a5a', flexWrap: 'wrap', gap: '3px', '@media (min-width: 769px)': { marginTop: '15px', paddingTop: '15px', gap: '10px' } },
  attempts: { fontSize: '6px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '13px' } },
  xpStats: { fontSize: '6px', color: '#ffd93d', fontWeight: 'bold', '@media (min-width: 769px)': { fontSize: '13px' } },
  hintButton: { padding: '2px 6px', fontSize: '6px', backgroundColor: '#4a6fa5', color: 'white', border: 'none', borderRadius: '4px', cursor: 'pointer', minHeight: '22px', '@media (min-width: 769px)': { padding: '6px 14px', fontSize: '12px', minHeight: '36px' } },
  tipsCard: { backgroundColor: '#1e1e2e', borderRadius: '6px', padding: '4px', marginTop: '4px', '@media (min-width: 769px)': { padding: '18px', borderRadius: '12px', marginTop: '10px' } },
  tipsTitle: { fontSize: '7px', marginBottom: '3px', color: '#ffd93d', '@media (min-width: 769px)': { fontSize: '16px', marginBottom: '12px' } },
  tipsList: { listStyle: 'none', padding: 0, margin: 0, fontSize: '5px', lineHeight: '1.3', color: '#ccc', '@media (min-width: 769px)': { fontSize: '13px', lineHeight: '1.8' } },
  completionContainer: { display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '200px', padding: '8px', '@media (min-width: 769px)': { minHeight: '400px', padding: '20px' } },
  completionCard: { backgroundColor: '#2a2a4a', borderRadius: '10px', padding: '12px', textAlign: 'center', maxWidth: '220px', width: '90%', '@media (min-width: 769px)': { padding: '35px', maxWidth: '450px', borderRadius: '20px' } },
  trophyIcon: { fontSize: '28px', marginBottom: '6px', '@media (min-width: 769px)': { fontSize: '56px', marginBottom: '15px' } },
  sadIcon: { fontSize: '28px', marginBottom: '6px', '@media (min-width: 769px)': { fontSize: '56px' } },
  completionTitle: { fontSize: '14px', marginBottom: '6px', color: '#ffd93d', '@media (min-width: 769px)': { fontSize: '28px', marginBottom: '15px' } },
  completionText: { fontSize: '8px', marginBottom: '10px', color: '#ccc', '@media (min-width: 769px)': { fontSize: '16px', marginBottom: '20px' } },
  finalScore: { backgroundColor: '#1e1e2e', padding: '6px', borderRadius: '6px', marginBottom: '10px', fontSize: '7px', lineHeight: '1.3', '@media (min-width: 769px)': { padding: '15px', fontSize: '14px', lineHeight: '1.8' } },
  continueButton: { padding: '5px 12px', fontSize: '9px', backgroundColor: '#4caf50', color: 'white', border: 'none', borderRadius: '6px', cursor: 'pointer', fontWeight: 'bold', minHeight: '30px', '@media (min-width: 769px)': { padding: '10px 25px', fontSize: '14px', minHeight: '48px' } }
};
