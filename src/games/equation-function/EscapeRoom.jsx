...
const styles = {
  container: { 
    ...
    '@media (min-width: 769px)': { maxWidth: '1000px', margin: '20px auto', padding: '24px', borderRadius: '20px' } 
  },
  enemyDefeatOverlay: { position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', zIndex: 1000, pointerEvents: 'none', width: '85%', maxWidth: '320px' },
  enemyDefeatBubble: { backgroundColor: '#ffd93d', padding: '14px 20px', borderRadius: '20px', display: 'flex', alignItems: 'center', gap: '12px', boxShadow: '0 4px 20px rgba(0,0,0,0.5)', flexWrap: 'wrap', justifyContent: 'center', '@media (min-width: 769px)': { padding: '20px 30px', gap: '20px' } },
  enemyDefeatEmoji: { fontSize: '32px', '@media (min-width: 769px)': { fontSize: '48px' } },
  enemyDefeatText: { fontSize: '16px', fontWeight: 'bold', color: '#333', '@media (min-width: 769px)': { fontSize: '22px' } },
  enemyDefeatXp: { fontSize: '14px', color: '#4caf50', fontWeight: 'bold', backgroundColor: 'white', padding: '4px 10px', borderRadius: '16px', '@media (min-width: 769px)': { fontSize: '18px', padding: '6px 14px' } },
  visualRoom: { position: 'relative', backgroundColor: '#2d1b0e', borderRadius: '12px', padding: '8px', marginBottom: '14px', minHeight: '160px', boxShadow: 'inset 0 0 20px rgba(0,0,0,0.6), 0 3px 8px rgba(0,0,0,0.4)', border: '2px solid #5c3a1e', overflow: 'hidden', '@media (min-width: 769px)': { padding: '24px', minHeight: '360px', borderRadius: '20px', borderWidth: '4px' } },
  roomWalls: { position: 'relative', height: '140px', '@media (min-width: 769px)': { height: '300px' } },
  roomWallLeft: { position: 'absolute', left: 0, top: 0, width: '8px', height: '100%', backgroundColor: '#8B6914', background: 'linear-gradient(180deg, #a07828 0%, #6b4c1a 100%)', borderRadius: '4px 0 0 4px', '@media (min-width: 769px)': { width: '24px' } },
  roomWallRight: { position: 'absolute', right: 0, top: 0, width: '8px', height: '100%', backgroundColor: '#8B6914', background: 'linear-gradient(180deg, #a07828 0%, #6b4c1a 100%)', borderRadius: '0 4px 4px 0', '@media (min-width: 769px)': { width: '24px' } },
  roomWallTop: { position: 'absolute', top: 0, left: 0, width: '100%', height: '8px', backgroundColor: '#8B6914', background: 'linear-gradient(90deg, #a07828 0%, #6b4c1a 100%)', borderRadius: '4px 4px 0 0', '@media (min-width: 769px)': { height: '24px' } },
  roomFloor: { position: 'absolute', bottom: 0, left: 0, width: '100%', height: '20px', backgroundColor: '#4a2a0a', background: 'repeating-linear-gradient(45deg, #5c3612, #5c3612 10px, #6b4015 10px, #6b4015 20px)', borderRadius: '0 0 8px 8px', '@media (min-width: 769px)': { height: '48px' } },
  escapeDoor: { position: 'absolute', bottom: '20px', width: '40px', height: '65px', transition: 'all 0.5s ease', cursor: 'pointer', zIndex: 10, '@media (min-width: 769px)': { bottom: '48px', width: '90px', height: '160px' } },
  escapeDoorOpen: { transform: 'translateX(4px)', opacity: 0.9 },
  doorFrame: { width: '100%', height: '100%', backgroundColor: '#3d2b1a', border: '2px solid #8B6914', borderRadius: '4px', boxShadow: 'inset 0 0 4px rgba(0,0,0,0.6)', position: 'relative', '@media (min-width: 769px)': { borderWidth: '4px' } },
  ...
  lockedDoorContent: { color: '#ff6b6b', fontSize: '10px', fontWeight: 'bold', textAlign: 'center', '@media (min-width: 769px)': { fontSize: '16px' } },
  lockedDoorText: { display: 'block', fontSize: '12px', '@media (min-width: 769px)': { fontSize: '20px' } },
  lockedDoorSubtext: { display: 'block', fontSize: '8px', marginTop: '2px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '12px', marginTop: '6px' } },
  openDoorContent: { color: '#4caf50', fontSize: '10px', fontWeight: 'bold', transform: 'rotate(-90deg)', whiteSpace: 'nowrap', '@media (min-width: 769px)': { fontSize: '18px' } },
  openDoorText: { display: 'inline-block' },
  doorKnob: { position: 'absolute', right: '3px', top: '50%', transform: 'translateY(-50%)', width: '4px', height: '4px', backgroundColor: '#ffd700', borderRadius: '50%', '@media (min-width: 769px)': { width: '12px', height: '12px', right: '6px' } },
  distanceIndicator: { position: 'absolute', bottom: '4px', left: '50%', transform: 'translateX(-50%)', backgroundColor: 'rgba(0,0,0,0.8)', padding: '4px 10px', borderRadius: '12px', fontSize: '11px', color: 'white', textAlign: 'center', zIndex: 15, whiteSpace: 'nowrap', '@media (min-width: 769px)': { bottom: '12px', padding: '10px 20px', fontSize: '16px' } },
  distanceBar: { width: '80px', height: '4px', backgroundColor: '#333', borderRadius: '3px', marginTop: '3px', overflow: 'hidden', '@media (min-width: 769px)': { width: '180px', height: '8px', marginTop: '6px' } },
  ...
  enemyAvatar: { backgroundColor: '#2a1a0a', borderRadius: '50%', width: '56px', height: '56px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '2px solid #ff4444', boxShadow: '0 0 10px rgba(255,0,0,0.6)', '@media (min-width: 769px)': { width: '100px', height: '100px', borderWidth: '4px' } },
  enemyEmoji: { fontSize: '30px', '@media (min-width: 769px)': { fontSize: '52px' } },
  enemyNameTag: { fontSize: '10px', backgroundColor: '#ff4444', padding: '2px 6px', borderRadius: '8px', marginTop: '3px', color: 'white', fontWeight: 'bold', '@media (min-width: 769px)': { fontSize: '14px', padding: '4px 10px', marginTop: '6px' } },
  playerSprite: { position: 'absolute', bottom: '20px', textAlign: 'center', zIndex: 5, transition: 'left 0.3s ease', '@media (min-width: 769px)': { bottom: '70px' } },
  playerAvatar: { backgroundColor: '#1a3a5c', borderRadius: '50%', width: '50px', height: '50px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', border: '2px solid #4caf50', boxShadow: '0 0 10px rgba(76,175,80,0.6)', '@media (min-width: 769px)': { width: '80px', height: '80px', borderWidth: '4px' } },
  playerEmoji: { fontSize: '28px', '@media (min-width: 769px)': { fontSize: '40px' } },
  playerNameTag: { fontSize: '9px', backgroundColor: '#4caf50', padding: '2px 6px', borderRadius: '8px', marginTop: '2px', color: 'white', fontWeight: 'bold', '@media (min-width: 769px)': { fontSize: '12px', padding: '2px 8px', marginTop: '4px' } },
  bloodEffect: { position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontSize: '36px', opacity: 0.8, animation: 'fadeOut 0.5s ease-out', pointerEvents: 'none', zIndex: 20, '@media (min-width: 769px)': { fontSize: '72px' } },
  puzzleArea: { marginTop: '12px', '@media (min-width: 769px)': { marginTop: '24px' } },
  header: { marginBottom: '12px' },
  scoreTimeContainer: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px', fontSize: '16px', fontWeight: 'bold', flexWrap: 'wrap', gap: '8px', '@media (min-width: 769px)': { fontSize: '22px', marginBottom: '12px', gap: '12px' } },
  score: { color: '#ffd93d', background: 'rgba(0,0,0,0.3)', padding: '4px 12px', borderRadius: '16px', '@media (min-width: 769px)': { padding: '6px 16px', borderRadius: '24px' } },
  timer: { color: '#ff6b6b', background: 'rgba(0,0,0,0.3)', padding: '4px 12px', borderRadius: '16px', '@media (min-width: 769px)': { padding: '6px 16px' } },
  livesContainer: { color: '#ff4444', background: 'rgba(0,0,0,0.3)', padding: '4px 12px', borderRadius: '16px', display: 'flex', alignItems: 'center', gap: '4px', fontSize: '14px', '@media (min-width: 769px)': { padding: '6px 16px', gap: '6px', fontSize: '20px' } },
  xpDisplay: { display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', marginBottom: '8px', padding: '6px 12px', backgroundColor: 'rgba(255,215,0,0.2)', borderRadius: '16px', fontSize: '14px', fontWeight: 'bold', color: '#ffd93d', flexWrap: 'wrap', '@media (min-width: 769px)': { gap: '12px', marginBottom: '12px', padding: '10px', fontSize: '18px' } },
  xpBreakdown: { fontSize: '12px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '14px' } },
  progressBar: { width: '100%', height: '6px', backgroundColor: '#1e1e2e', borderRadius: '4px', overflow: 'hidden', marginBottom: '6px', '@media (min-width: 769px)': { height: '10px', marginBottom: '10px' } },
  progressFill: { height: '100%', backgroundColor: '#4caf50', transition: 'width 0.3s ease' },
  progressText: { textAlign: 'center', fontSize: '13px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '16px' } },
  equationCard: { backgroundColor: '#1e1e2e', borderRadius: '12px', padding: '16px', textAlign: 'center', '@media (min-width: 769px)': { padding: '36px', borderRadius: '20px' } },
  difficultyBadge: { display: 'inline-block', padding: '4px 12px', borderRadius: '16px', fontSize: '12px', fontWeight: 'bold', marginBottom: '12px', color: '#fff', textTransform: 'uppercase', '@media (min-width: 769px)': { padding: '6px 16px', fontSize: '14px', marginBottom: '28px' } },
  mcContainer: { marginBottom: '16px' },
  mcQuestionText: { fontSize: '18px', color: '#fff', marginBottom: '16px', lineHeight: '1.5', whiteSpace: 'pre-line', textAlign: 'center', fontWeight: '500', '@media (min-width: 769px)': { fontSize: '26px', marginBottom: '30px' } },
  optionsContainer: { display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '16px', '@media (min-width: 769px)': { gap: '14px', marginBottom: '24px' } },
  optionButton: { display: 'flex', alignItems: 'center', gap: '10px', padding: '12px 16px', backgroundColor: '#2a2a4a', border: '2px solid #4a4a6a', borderRadius: '10px', cursor: 'pointer', transition: 'all 0.2s', textAlign: 'left', fontSize: '15px', color: '#fff', '@media (min-width: 769px)': { gap: '18px', padding: '18px 24px', fontSize: '20px', borderRadius: '12px' } },
  optionLetter: { fontWeight: 'bold', fontSize: '16px', minWidth: '24px', color: '#ffd93d', '@media (min-width: 769px)': { fontSize: '22px', minWidth: '36px' } },
  optionText: { flex: 1, fontSize: '14px', lineHeight: '1.4', '@media (min-width: 769px)': { fontSize: '18px' } },
  answerContainer: { marginBottom: '16px', padding: '8px', backgroundColor: '#0f0f1f', borderRadius: '12px', border: '2px solid #ff9800', '@media (min-width: 769px)': { marginBottom: '28px', padding: '28px', borderRadius: '20px' } },
  answerSubmitButton: { width: '100%', padding: '14px 16px', fontSize: '16px', backgroundColor: '#ff4444', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', transition: 'all 0.3s', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '1px', minHeight: '48px', '@media (min-width: 769px)': { padding: '22px 28px', fontSize: '22px', letterSpacing: '3px', minHeight: '72px' } },
  feedback: { padding: '10px', marginBottom: '10px', backgroundColor: '#2a2a4a', borderRadius: '10px', fontSize: '14px', lineHeight: '1.5', color: '#fff', '@media (min-width: 769px)': { padding: '16px', fontSize: '18px' } },
  feedbackDeath: { padding: '10px', marginBottom: '10px', backgroundColor: '#8b0000', borderRadius: '10px', fontSize: '14px', lineHeight: '1.5', color: '#fff', fontWeight: 'bold', '@media (min-width: 769px)': { padding: '16px', fontSize: '18px' } },
  hint: { padding: '10px', marginBottom: '10px', backgroundColor: '#ff9800', borderRadius: '10px', fontSize: '14px', color: '#fff', '@media (min-width: 769px)': { padding: '16px', fontSize: '18px' } },
  stats: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '10px', paddingTop: '10px', borderTop: '2px solid #3a3a5a', flexWrap: 'wrap', gap: '8px', '@media (min-width: 769px)': { marginTop: '18px', paddingTop: '18px', gap: '12px' } },
  attempts: { fontSize: '13px', color: '#aaa', '@media (min-width: 769px)': { fontSize: '16px' } },
  xpStats: { fontSize: '13px', color: '#ffd93d', fontWeight: 'bold', '@media (min-width: 769px)': { fontSize: '16px' } },
  hintButton: { padding: '6px 14px', fontSize: '13px', backgroundColor: '#4a6fa5', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', minHeight: '34px', '@media (min-width: 769px)': { padding: '8px 18px', fontSize: '16px', minHeight: '44px' } },
  tipsCard: { backgroundColor: '#1e1e2e', borderRadius: '10px', padding: '10px', marginTop: '10px', '@media (min-width: 769px)': { padding: '22px', borderRadius: '16px', marginTop: '14px' } },
  tipsTitle: { fontSize: '14px', marginBottom: '6px', color: '#ffd93d', '@media (min-width: 769px)': { fontSize: '20px', marginBottom: '14px' } },
  tipsList: { listStyle: 'none', padding: 0, margin: 0, fontSize: '12px', lineHeight: '1.6', color: '#ccc', '@media (min-width: 769px)': { fontSize: '16px', lineHeight: '2' } },
  completionContainer: { display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '300px', padding: '16px', '@media (min-width: 769px)': { minHeight: '450px', padding: '24px' } },
  completionCard: { backgroundColor: '#2a2a4a', borderRadius: '16px', padding: '20px', textAlign: 'center', maxWidth: '320px', width: '90%', '@media (min-width: 769px)': { padding: '42px', maxWidth: '500px', borderRadius: '24px' } },
  trophyIcon: { fontSize: '48px', marginBottom: '10px', '@media (min-width: 769px)': { fontSize: '64px', marginBottom: '18px' } },
  sadIcon: { fontSize: '48px', marginBottom: '10px', '@media (min-width: 769px)': { fontSize: '64px' } },
  completionTitle: { fontSize: '24px', marginBottom: '10px', color: '#ffd93d', '@media (min-width: 769px)': { fontSize: '34px', marginBottom: '18px' } },
  completionText: { fontSize: '15px', marginBottom: '14px', color: '#ccc', '@media (min-width: 769px)': { fontSize: '20px', marginBottom: '24px' } },
  finalScore: { backgroundColor: '#1e1e2e', padding: '14px', borderRadius: '10px', marginBottom: '14px', fontSize: '13px', lineHeight: '1.6', '@media (min-width: 769px)': { padding: '20px', fontSize: '17px', lineHeight: '2' } },
  continueButton: { padding: '12px 24px', fontSize: '16px', backgroundColor: '#4caf50', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', fontWeight: 'bold', minHeight: '44px', '@media (min-width: 769px)': { padding: '14px 32px', fontSize: '18px', minHeight: '56px' } }
};
