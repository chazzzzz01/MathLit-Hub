  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.contentWrapper}>
        <div style={styles.welcomeHeader}><h1 style={styles.welcomeTitle}>Welcome, Teacher {user?.name?.split(' ')[0] || user?.email?.split('@')[0] || 'Teacher'}! 👋</h1><p style={styles.welcomeSubtitle}>Create classes and share the code with your students.</p></div>
